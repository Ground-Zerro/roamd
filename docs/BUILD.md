...
| Файл | Строка |
|---|---|
| `package/roamd/Makefile` | `PKG_VERSION:=1.0.1-r25` |
| `package/luci-app-roamd/Makefile` | `PKG_VERSION:=1.0.1-r7`, `PKG_PO_VERSION:=$(PKG_VERSION)` |
...
начинаются с ветки и архитектуры (`25.12-x86_64-roamd-1.0.1-r25.apk`).
